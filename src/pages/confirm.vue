      ...
      <div class="order-box">
          <div class="item-address">
              ...
              <div class="addr-list  clearfix">
                  <!-- in list商城地址列表 绑定:key缓存组件用提高渲染速度-->
              ...
              <div class="datail">
                 ...
                 <div class="item-total">
                    <span class="item-name"> 应付总金额:</span>
                    <span class="item-val">{{cartTotalPrice}}元</span>
                 </div>
                 <div class="btn-group">
...
export default {
    ...
    methods:{
      ...
      // 地址删除 编辑 新增功能
      submitAddress(){
        // let item =this.checkedItem.action
        // let checkedItem=this.checkedItem;
        // let userAction=this.userAction;
        let {checkedItem,userAction}=this;//解构
      ...
      getCartList(){
          this.axios.get('/Carts').then((res)=>{
            let list =res.cartProductVoList;//获取购物车中所有的商品数据
              this.cartTotalPrice=res.cartTotalPrice;//选中的商品总金额
              //filter直接是一个作用和过滤的功能和方法 过滤出已经选中的商品
              this.cartList=list.filter(item=>item.productSeleted);//还有map for循环都可以过滤 
